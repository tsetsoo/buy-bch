  ...
  return (
    <div className="header-container">
      ...
      <div className="language-desktop">
        <div className={getLanguageClasses(labels.en)} onClick={() => setLanguage("en")}>{labels.en}</div>
        <div className={getLanguageClasses(labels.bg)} onClick={() => setLanguage("bg")}>{labels.bg}</div>
      </div>
    </div>
  );
};
